...
Built-in codes: `VALIDATION_ERROR`, `OUTPUT_VALIDATION_ERROR`, `PARSE_ERROR`, `UNAUTHORIZED`, `RATE_LIMIT`, `CSRF_ERROR`, `IDEMPOTENCY_KEY_REQUIRED`, `IDEMPOTENCY_KEY_REUSE`, `IDEMPOTENCY_STORE_ERROR`, `SERVER_ERROR`, `INTERNAL_ERROR`, `FETCH_ERROR`, `ABORT_ERROR`, `TIMEOUT_ERROR`, `STREAM_ERROR`.
